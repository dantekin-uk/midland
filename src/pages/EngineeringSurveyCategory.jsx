...
const EngineeringSurveyCategory = () => {
  ...
  const services = [
    {
      ...
      slug: "geodetic-control-networks",
      image: engineering,
      desc: "Establishing high-accuracy spatial frameworks for large-scale projects."
    },
    {
      title: "Topographic Surveys",
      slug: "topographic-surveys",
      image: topography,
      desc: "Mapping existing site conditions to inform design and planning."
    },
    {
      title: "Civil & Construction Set-out",
      slug: "civil-construction-setout",
      image: engineering,
      desc: "Ensuring accuracy for buildings, bridges, and road infrastructure."
    },
    {
      title: "As-Constructed Surveys",
      slug: "as-constructed-surveys",
      image: documentation,
      desc: "Final mapping and verification of completed infrastructure."
    },
    {
      title: "Monitoring & Volume Surveys",
      slug: "monitoring-volume-surveys",
      image: earthworks,
      desc: "Precise tracking of structural movement and earthwork quantities."
    }
  ];

  const categoryTitle = "Engineering Survey";
  const categoryDescription = `Our Engineering Survey Services

From civil set-outs for residential developments to monitoring and volume surveys, and construction set-outs for diverse infrastructures, our engineering surveying service ensures accuracy and reliability across various projects.

• Geodetic survey control networks
• Topographic Survey to map existing conditions of a site.
• Civil set out for residential subdivisions, including earthworks, services and kerb and channel
• As constructed surveys
• Monitoring surveys
• Volume surveys
• Construction set out surveys of buildings, bridges and road infrastructure.`;
      ...
      <section className="relative pt-16 sm:pt-20 md:pt-24 px-4 lg:px-6">
        <div className="relative w-full max-w-[95%] mx-auto h-[250px] sm:h-[180px] md:h-[220px] lg:h-[300px] overflow-hidden rounded-2xl rounded-br-[80px] sm:rounded-br-[120px] lg:rounded-br-[150px] shadow-2xl shadow-slate-200">
          <div className="absolute inset-0">
            <img src={engineering} alt="Engineering Survey" className="w-full h-full object-cover object-center" loading="eager" />
          ...
          <div className="relative z-10 h-full flex items-end pb-8 sm:pb-6 md:pb-8 px-3 sm:px-4 md:px-6 lg:px-12 lg:items-center lg:pb-4">
            <div className="max-w-full sm:max-w-md md:max-w-lg lg:max-w-2xl space-y-1 sm:space-y-2 md:space-y-3 lg:space-y-4">
              ...
              >
                Precision engineering surveys providing millimeter accuracy for infrastructure set-outs and reliable development.
              </motion.p>
              <motion.div
        ...
        <div className="w-full max-w-[95%] mx-auto px-4">
          ...
          >
            <h2 className="text-2xl lg:text-3xl font-black tracking-tighter leading-tight bg-gradient-to-r from-primary to-steel-grey bg-clip-text text-transparent drop-shadow-sm">
              Our Engineering Survey Services
            </h2>
          </motion.div>
          ...
          >
            <div className="relative z-10">
              <h2 className="text-2xl lg:text-4xl font-black tracking-tighter leading-tight mb-4 text-white">
                Need Engineering <span className="text-white/80">Survey Services?</span>
              </h2>
              <p className="text-sm lg:text-base mb-8 text-white/80 max-w-2xl mx-auto font-medium">
                Our expert engineering surveyors are ready to provide precision-driven solutions for your infrastructure projects.
              </p>
              <Link 
                to="/contact" 
...
export default EngineeringSurveyCategory;
