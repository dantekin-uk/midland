    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-green-700 text-white py-16">
        <div className="container mx-auto px-6">
          <Link to="/services" className="text-green-200 hover:text-white mb-4 inline-block">
            ← Back to Services
          </Link>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6 text-gray-800">Precision Engineering Surveys</h2>
            ...
            <div className="bg-green-50 p-8 rounded-lg">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">Building construction</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-green-600 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span className="text-gray-700">Road and highway projects</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-green-600 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span className="text-gray-700">Bridge and infrastructure</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-green-600 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-800">Construction Layout</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-800">Deformation Monitoring</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-800">As-Built Surveys</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-800">Control Surveys</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-800">Infrastructure Surveying</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-800">Machine Control</h3>
              <p className="text-gray-600">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-800">Total Stations</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-800">GPS/GNSS Systems</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-800">3D Laser Scanning</h3>
              <p className="text-gray-600">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-800">Project Analysis</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-800">Control Network</h3>
              <p className="text-gray-600">
