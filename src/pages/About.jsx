            ...
            >
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed font-medium text-xs sm:text-sm">
                ...
                <p>
                  ...
                  with the Surveyors Board of Kenya and the Institute of Surveyors of Kenya. By utilizing the latest 
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  {
                    org: "Surveyors Board of Kenya (SBK)",
                    desc: "Our professionals are proudly registered with the board, ensuring all our cadastral and legal surveys meet strict statutory requirements.",
                    icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
                  },
                  {
                    org: "Institution of Surveyors of Kenya (ISK)",
                    desc: "As registered members, we are committed to upholding the rigorous ethical and technical standards set forth by the institution for all engineering, topographical, and land management projects.",
